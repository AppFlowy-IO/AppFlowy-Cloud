...
impl Client {
  ...
  /// The URL is generated by [Client::generate_sign_in_url_with_provider] or [Client::generate_sign_in_url_with_email] method.
  ///
  ...
  /// it constructs and returns the authorization URL. The URL can be used to sign in using the
  /// [Client::sign_in_with_url] method.
  ///
  /// # Parameters
  ...
  ///
  pub async fn generate_sign_in_url_with_provider(
    &self,
