...
impl Client {
  pub async fn create_template_category(
    ...
    let url = format!("{}/api/template/category", self.base_url);
    let resp = self
  ...
  pub async fn get_template_category(
    ...
    let url = format!("{}/api/template/category/{}", self.base_url, category_id);
    let resp = self
      .http_client_without_auth(Method::GET, &url)
      .await?
      .send()
  ...
  pub async fn create_template_creator(
    ...
    let url = format!("{}/api/template/creator", self.base_url);
    let resp = self
      .http_client_with_auth(Method::POST, &url)
      .await?
  ...
  pub async fn get_template_creator(
    ...
    let url = format!("{}/api/template/creator/{}", self.base_url, creator_id);
    let resp = self
      .http_client_without_auth(Method::GET, &url)
      .await?
      .send()
  ...
  pub async fn delete_template_creator(&self, creator_id: &Uuid) -> Result<(), AppResponseError> {
    let url = format!("{}/api/template/creator/{}", self.base_url, creator_id);
    let resp = self
      .http_client_without_auth(Method::DELETE, &url)
      .await?
      .send()
      .await?;
    AppResponse::<()>::from_response(resp).await?.into_error()
