...
/// for a given user and workspace. It processes a
...
///
/// -  Using a transaction ensures that all database operations (insert/update for
///   `af_collab`) succeed or fail together. This means that if any part of the
