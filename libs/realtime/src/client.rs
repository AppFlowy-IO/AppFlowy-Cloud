use crate::collaborate::{RealtimeCollabAccessControl, RealtimeServer};
...
pub struct RealtimeClient<
  ...
  S: Unpin + 'static,
  AC: Unpin + RealtimeCollabAccessControl,
> {
  session_id: String,
  user: U,
  hb: Instant,
...
where
  ...
  AC: RealtimeCollabAccessControl + Unpin,
{
  pub fn new(
    user: U,
...
where
  ...
  P: RealtimeCollabAccessControl + Unpin,
{
