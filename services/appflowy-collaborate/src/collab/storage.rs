...
/// Collab storage implementation with caching and snapshot control.
#[derive(Clone)]
pub struct CollabStorageWithCache {
  cache: CollabCache,
...
#[async_trait]
impl CollabStorage for CollabStorageWithCache {
