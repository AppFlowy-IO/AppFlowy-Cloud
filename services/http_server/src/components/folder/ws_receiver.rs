...
use crate::{context::FolderRevisionKV, components::kv::revision_kv::revisions_to_key_value_items};
...
use crate::util::error_ext::into_collaborate_error;
    ...
    fn read_folder(&self, _user_id: &str, folder_id: &str) -> BoxResultFuture<FolderInfo, CollaborateError> {
        ...
        Box::pin(async move {
            let revisions = folder_store
                ...
                .await
                .map_err(into_collaborate_error)?;
